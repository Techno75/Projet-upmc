    ...
    return (
      <Link to={{pathname : routesList[10].path , aboutProps : {match : this.props.match}}}>
        <div className={"match-card " + this.props.class}>
            <div>
              <img src={require("./../../Assets/Images/Flags/" + this.props.match.home_team.code + ".jpg")} alt="flag"/> {this.props.match.home_team_country} {this.props.match.home_team.goals}
            </div>
            <div>
            ...
            <div>
              <img src={require("./../../Assets/Images/Flags/" + this.props.match.away_team.code + ".jpg")} alt="flag"/>{this.props.match.away_team_country} {this.props.match.away_team.goals}
            </div>
        </div>
      </Link>
    )
