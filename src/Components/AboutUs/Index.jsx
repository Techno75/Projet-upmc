  ...
  render() {
    return (
          <div className="content-about-us">
            <h2>About Us</h2>
            <div className="text-about-us"><p className="text-para">Dans le monde actuel, de trop nombreuses femmes se voient interdire l’accès au sport à cause
...
part à ce combat pour les droits des femmes à travers le monde.</p>
...
qu’apporte la performance de ces sportives de haut niveau.</p></div>
          </div>
    )
  }
}
